        ...
        <div class="row">
            <div class="col col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                <div class="row row-cols-1 row-cols-md-2 g-4">
                    ...
                    <div class="col">
                      <div class="card">
                        <img src="images\interior6.jpg" class="card-img-top" alt="..." height="200" width="500">
                    ...
                    <div class="col">
                      <div class="card">
                        <img src="images\interior11.jpg" class="card-img-top" alt="..." height="200" width="500">
                        
                      </div>
                    </div>
                    <div class="col">
                        <div class="card">
                          <img src="images\interior4.jpg" class="card-img-top" alt="..." height="200" width="500">
                          
                        </div>
                      </div>
                      <div class="col">
                        <div class="card">
                          <img src="images\interior3.jpg" class="card-img-top" alt="..." height="200" width="500">
